                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <div className="hidden size-full dark:block bg-gradient-to-br from-transparent to-background" aria-hidden />
                        </AnimatedGroup>
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Join the Trekky Community</span>
                                        <span
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button asChild size="lg" className="rounded-xl px-5 text-base">
                                            <Link to="/auth">
                                                <span className="text-nowrap">Start Trekking</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
